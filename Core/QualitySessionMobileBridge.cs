...
public sealed class QualitySessionMobileBridge : ISubscriber, IDisposable {
    ...
    public static IDictionary<string, object> BuildSnapshot() {
        ...
        var result = new Dictionary<string, object> {
            ...
            ["mode"] = new Dictionary<string, object> {
                ...
                ["syntheticStatus"] = runtime.SyntheticStatus,
                ["syntheticSessionName"] = runtime.SyntheticSessionName
            },
    ...
    private static IDictionary<string, object> MobileFrame(FrameQualityResult frame) => new Dictionary<string, object> {
        ...
        ["finalFileName"] = frame.FinalFileName,
        ["fileDisposition"] = frame.FileDispositionText,
        ["badFileApplied"] = frame.IsBadFileApplied,
        ["syntheticFile"] = frame.IsSyntheticFile,
        ["sequenceTitle"] = frame.SequenceTitle ?? "",
        ["maxGuideExcursionArcsec"] = JsonNumber(frame.MaxGuideExcursionArcsec),
        ["guidePattern"] = frame.GuidePatternText,
        ["guidePatternConfidence"] = JsonNumber(frame.GuidePatternConfidence),
